...
def get_predictors_pandas(filtered_data):
    ...
    logistic_data['rew_first_inter'] = logistic_data['rewarded'] * logistic_data['same_first_action']
    ...
    logistic_data = logistic_data[logistic_data['same_second_state'] == 0]
    #print(logistic_data)
...
probs = (
    expit(coefs[0] + coefs[1] + coefs[2] + coefs[3]), #intercept, rewarded, same first action
    expit(coefs[0] + coefs[1] - coefs[2] - coefs[3]), #intercept, rewarded, diff first action
    expit(coefs[0] - coefs[1] + coefs[2] - coefs[3]), #intercept, unrewarded, same first action
    expit(coefs[0] - coefs[1] - coefs[2] + coefs[3]), #intercept, unrewarded, diff first action
)
