...
for model in models:
    ...
    coefs_ind.append(coefs)

print(coefs_ind)
coefs_ind = np.array(coefs_ind)
avg_coef = np.average(coefs_ind, axis=0)
...
probs = (
    expit(avg_coef[0] + avg_coef[1] + avg_coef[2] + avg_coef[4]), #rewarded, same
    expit(avg_coef[0] - avg_coef[1] + avg_coef[2] - avg_coef[4]), #unrewarded, same
    expit(avg_coef[0] + avg_coef[1] - avg_coef[2] - avg_coef[4]), #rewarded, different
    expit(avg_coef[0] - avg_coef[1] - avg_coef[2] + avg_coef[4]), #unrewarded, different
)
