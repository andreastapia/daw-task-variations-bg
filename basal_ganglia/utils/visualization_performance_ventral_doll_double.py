...
base_dir = 'basal_ganglia/results/doll_task_ventral_fixed_double/'
...
ax1.plot(np.arange(prop.shape[0]), prop[:,2], label='(F2,S1)', color='red')
ax1.plot(np.arange(prop.shape[0]), prop[:,6], label='(T2,S1)', color='purple')
ax1.plot(np.arange(prop.shape[0]), prop[:,1] + prop[:,5], label='Opción B2', color='darkgoldenrod')
ax1.plot(np.arange(prop.shape[0]), prop[:,2] + prop[:,6], label='Opción S1', color='black')
ax1.plot(np.arange(prop.shape[0]), prop[:,1] + prop[:,5]+ prop[:,2]+ prop[:,6], label='Opción B2 o S1', color='green')
fig.tight_layout()
