...
def objective(trial):
    tau_NAccD1_shell = trial.suggest_int('tau_NAccD1_shell', 0.0, 30.0, step=1) #10.0
    noise_NAccD1_shell = trial.suggest_float('noise_NAccD1_shell', 0.0, 1.0,step=0.05) #0.3
    baseline_NAccD1_shell = trial.suggest_float('baseline_NAccD1_shell', 0.0, 1.0 ,step=0.05) #0.0
    lesion_NAccD1_shell = trial.suggest_float('lesion_NAccD1_shell', 0.0, 5.0 ,step=0.1) #1.0
    tau_trace_NAccD1_shell = trial.suggest_int('tau_trace_NAccD1_shell', 0, 300,step=1) #gen_tau_trace 100

    tau_VentralBG_VP_dir = trial.suggest_int('tau_VentralBG_VP_dir', 0.0, 30.0, step=1) #10.0
    noise_VentralBG_VP_dir = trial.suggest_float('noise_VentralBG_VP_dir', 0.0, 1.0, step=0.05) #0.3 #0.3
    baseline_VentralBG_VP_dir = trial.suggest_float('baseline_VentralBG_VP_dir', 0.0, 5.0, step=0.1) #1.5 #0.75 #1.5
    tau_trace_VentralBG_VP_dir = trial.suggest_int('tau_trace_VentralBG_VP_dir', 0, 300, step=1) #gen_tau_trace

    tau_VentralBG_Thal = trial.suggest_int('tau_VentralBG_Thal', 0.0, 30.0, step=1) # 10.0
    noise_VentralBG_Thal = trial.suggest_float('noise_VentralBG_Thal', 0.0, 0.5,step=0.005) # 0.025 / 2.0
    baseline_VentralBG_Thal = trial.suggest_float('baseline_VentralBG_Thal',0.0, 5.0 ,step=0.1) # 1.2
    
    #hippo to strd1
    tau_ITStrD1_shell = trial.suggest_int('tau_ITStrD1_shell', 100, 500, step=5)
    regularization_threshold_ITStrD1_shell = trial.suggest_float('regularization_threshold_ITStrD1_shell', 0.0, 3.0, step=0.1)
    tau_alpha_ITStrD1_shell = trial.suggest_float('tau_alpha_ITStrD1_shell', 1.0, 10.0, step=0.1)
    baseline_dopa_ITStrD1_shell = trial.suggest_float('baseline_dopa_ITStrD1_shell', 0.0, 1.0, step=0.05)
    k_dip_ITStrD1_shell = trial.suggest_float('k_dip_ITStrD1_shell', 0.0, 0.1, step=0.005)
    k_burst_ITStrD1_shell = trial.suggest_float('k_burst_ITStrD1_shell', 0.0, 2.0, step=0.1)
    threshold_pre_ITStrD1_shell = trial.suggest_float('threshold_pre_ITStrD1_shell', 0.0, 1.0, step=0.05)
    threshold_post_ITStrD1_shell = trial.suggest_float('threshold_post_ITStrD1_shell', 0.0, 1.0, step=0.05)

    #strd1 to vpdir
    tau_StrD1VP_dir = trial.suggest_int('tau_StrD1VP_dir', 1000, 3000, step=20)
    regularization_threshold_StrD1VP_dir = trial.suggest_float('regularization_threshold_StrD1VP_dir', 2.0, 5.0, step=0.1)
    tau_alpha_StrD1VP_dir = trial.suggest_float('tau_alpha_StrD1VP_dir', 1.0, 20.0, step=0.1)
    baseline_dopa_StrD1VP_dir = trial.suggest_float('baseline_dopa_StrD1VP_dir', 0.0, 1.0, step=0.05)
    k_dip_StrD1VP_dir = trial.suggest_float('k_dip_StrD1VP_dir', 0.0, 2.0, step=0.1)
    k_burst_StrD1VP_dir = trial.suggest_float('k_burst_StrD1VP_dir', 0.0, 2.0, step=0.1)
    threshold_pre_StrD1VP_dir = trial.suggest_float('threshold_pre_StrD1VP_dir', 0.0, 1.0, step=0.05)
    threshold_post_StrD1VP_dir = trial.suggest_float('threshold_post_StrD1VP_dir', 0.0, 1.0, step=0.05)
    
    #vpdir to thal
    w_VPThal = trial.suggest_float('w_VPThal', 0.0, 3.0, step=0.1) # 1.5
    w_ObjObj = trial.suggest_float('w_ObjObj', 0.0, 3.0, step=0.1)  #0.75

    w_StrD1StrD1_shell = trial.suggest_float('w_StrD1StrD1_shell', 0.0, 2.0, step=0.1)
    w_VPVP_shell = trial.suggest_float('w_VPVP_shell', 0.0, 2.0, step=0.1)
    
    w_ThalThal = trial.suggest_float('w_ThalThal', 0.0, 1.0, step=0.1)
    w_StrThalVP_dir = trial.suggest_float('w_StrThalVP_dir', 0.0, 2.0, step=0.1)

    tau_HippoRPELayerRPE = trial.suggest_int('tau_HippoRPELayerRPE', 0, 400, step=5)
    tau_RPEVTA = trial.suggest_int('tau_RPEVTA', 0.0, 6000.0, step=20)
