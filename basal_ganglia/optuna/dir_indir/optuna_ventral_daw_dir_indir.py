...
def objective(trial):
    ...
    threshold_post_ITStrD2_shell = trial.suggest_float('threshold_post_ITStrD2_shell', 0.001, 0.02)
    ...
    threshold_post_StrD2VP_indir = trial.suggest_float('threshold_post_StrD2VP_indir', 0.0, 0.3)
...
study = optuna.create_study(
    study_name='bg_bigger_dir_indir_2',
