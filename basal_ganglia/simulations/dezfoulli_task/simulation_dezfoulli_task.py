...
from models.dezfoulli_task.projections import *
...
def dezfoulli_task():
    ...
    result_path = 'basal_ganglia/results/dezfoulli_task_bigger_pretrain_2/simulation_{date}/'.format(date=now.strftime("%Y%m%d%H%M%S"))
    ...
    for trial in range(num_trials):        
        ...
        # first action in range [0,1]
        # first action -> action 1, second action -> action 2
