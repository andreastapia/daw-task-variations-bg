...
def dezfoulli_task_ventral_fixed():
    now = datetime.datetime.now()
    result_path = 'basal_ganglia/results/dezfoulli_task_ventral_fixed/simulation_{date}/'.format(date=now.strftime("%Y%m%d%H%M%S"))
    ...
    selected_objectives=[]
    achieved_sequences=[]
    reward_of_actions=[0.2, 0.7, 0.2, 0.2]
    dopamine_activities=[]
