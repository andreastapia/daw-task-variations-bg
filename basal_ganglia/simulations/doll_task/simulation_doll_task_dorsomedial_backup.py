...
ObjStrD2_caud.connect_all_to_all(weights = Normal(0.09,0.03)) #0.005
...
StrD1GPi.connect_all_to_all(weights=Normal(0.15,0.01)) # scale by numer of stimuli #var 0.01
StrD1GPi.tau = 1800 #700 #550
StrD1GPi.regularization_threshold = 2.4 #1.5
StrD1GPi.tau_alpha = 8.0 # 20.0
StrD1GPi.baseline_dopa = 8*baseline_dopa_caud
StrD1GPi.K_dip = 0.9
StrD1GPi.K_burst = 1.0
StrD1GPi.threshold_post = 0.35 #0.1 #0.3
...
GPiThal_caud.connect_one_to_one(weights=1.6)
